...
class facturas_model(models.Model):
    ...
    productos_id = fields.Many2many("empresa.productos_model", string="Productos")
    ...
    def _calc_base(self):
        ...
        for i in self.productos_id:
            suma += i.pvp
        self.base = suma*self.cantidad

    @api.depends('iva', 'base')
    def _calc_iva(self):
        self.total = (((self.base*int(self.iva))/100)+self.base)*self.cantidad
